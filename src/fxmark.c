...
static struct bench_desc bench_table[] = {
	...
	{"DRBL_bg",
	 ...
	 &n_file_rd_ops},
	{"DRBL_seq",
	 "file seqential read with a background writer",
	 &n_file_rd_seq_ops},
    {"DRBM",
    ...
    {"DRBM_bg",
	 ...
	 &n_shfile_rd_bg_ops},
    {"DRBM_seq",
	 "shared file seq read: each process reads its private region of the shared file",
	 &n_shfile_rd_seq_ops},
    {"DRBH",
    ...
    {"DRBH_bg",
	 ...
	 &n_shblk_rd_bg_ops},
    {"DRBH_seq",
	 "shared blk seq read: each process reads the same page of the shared file",
	 &n_shblk_rd_seq_ops},
    {"MRDL",
